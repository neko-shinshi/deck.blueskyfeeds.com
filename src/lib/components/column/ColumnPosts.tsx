    ...
    return <>
        <div className="h-[3rem] flex place-items-center gap-2 justify-between">
            <div className="flex place-items-center h-full gap-1 overflow-hidden">
                ...
                <div className="w-8 h-8 border border-black rounded-full shrink-0 relative">

                    <div className="h-8 w-8 absolute inset-0 bg-theme_dark-L0 rounded-full border border-theme_dark-I0">
        ...
        <div className="flex flex-col overflow-y-hidden hover:overflow-y-auto scrollbar scrollbar-thins pr-4 h-[calc(100%-3rem)] text-black gap-2">
            {
